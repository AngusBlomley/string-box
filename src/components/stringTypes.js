...
function StringTypes() {
    ...
    return (
        <section id="string-types" className="py-0 w-9/12 mx-auto mt-36 max-lg:mx-0 max-lg:mt-5 max-lg:w-full">
            ...
            <div className="border-b-8 border-l-8 border-black leading-normal px-20 pb-20 mt-0 grid grid-cols-4 gap-y-10 border-5 max-lg:grid-cols-1 max-lg:mt-0 max-lg:mx-0 max-lg:my-0 max-lg:py-0 max-lg:pl-20 max-lg:pr-10 max-lg:border-0">
                ...
                <Image
                    ...
                    height={1500}
                    width={1500}
                    className='absolute left-1/2 -translate-x-1/2 -translate-y-80 w-1500 h-1500 py-44 -z-20'
                />
                ...
                */}
                ...
                <div className='col-span-2'>
                    <div className='h-7 w-7 bg-clay-red rounded-3xl -mb-7 -ml-10'></div>
                    <h1 className='font-hiraKakuW8 font-extrabold text-lg text-midnight-blue'>Solid Core</h1>
                ...
                <div className='col-span-2'>
                    <div className='h-7 w-7 bg-clay-red rounded-3xl -mb-7 -ml-10'></div>
                    <h1 className=' font-hiraKakuW8 font-extrabold text-lg text-midnight-blue'>Multi Fiber</h1>
                    <ul className='list-disc list-outside w-4/6 max-lg:w-full'>
                ...
                <div className='col-span-2'>
                    <div className='h-7 w-7 bg-clay-red rounded-3xl -mb-7 -ml-10'></div>
                    <h1 className=' font-hiraKakuW8 font-extrabold text-lg text-midnight-blue'>Natural Gut</h1>
                    <ul className='list-disc list-outside w-4/6 max-lg:w-full'>
                ...
                <div></div>
                <div className='flex justify-end items-end'><h2 className='text-2xl font-hiraKakuW8 text-midnight-blue transform translate-x-16 translate-y-16 max-lg:hidden'>Tension</h2></div>
