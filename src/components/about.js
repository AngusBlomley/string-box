...
export default function About() {
    ...
    return (
        ...
        <section className="relative mx-auto py-10 mt-36 w-full max-lg:p-10 max-lg:mt-0 pb-0">
            <Image
            ...
            <div className="flex flex-row justify-center max-lg:justify-start">
                ...
                />
                <div className="ml-10 bg-clay-red w-14 h-96 shadow-2xl max-lg:ml-0 max-lg:h-64"></div>
